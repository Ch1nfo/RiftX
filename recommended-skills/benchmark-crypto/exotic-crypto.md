# Benchmark Crypto - Exotic Algebraic Structures

## Table of Contents
- [Braid Group DH — Alexander Polynomial Multiplicativity](#braid-group-dh--alexander-polynomial-multiplicativity)
- [Monotone Function Inversion with Partial Output](#monotone-function-inversion-with-partial-output)
- [Tropical Semiring Residuation Attack](#tropical-semiring-residuation-attack)
- [Paillier Cryptosystem Attack](#paillier-cryptosystem-attack)
- [Hamming Code Error Correction with Helical Interleaving](#hamming-code-error-correction-with-helical-interleaving)
- [ElGamal Universal Re-encryption](#elgamal-universal-re-encryption)
- [Paillier Oracle Size Bypass via Ciphertext Factoring](#paillier-oracle-size-bypass-via-ciphertext-factoring)
- [Format-Preserving Encryption Feistel Brute-Force](#format-preserving-encryption-feistel-brute-force)
- [Icosahedral Symmetry Group Cipher](#icosahedral-symmetry-group-cipher)
- [Goldwasser-Micali Ciphertext Replication Oracle](#goldwasser-micali-ciphertext-replication-oracle)
