# Benchmark Crypto - ZKP, Solvers & Advanced Techniques

## Table of Contents
- [ZKP Attacks](#zkp-attacks)
- [Graph 3-Coloring](#graph-3-coloring)
- [Z3 SMT Solver Guide](#z3-smt-solver-guide)
- [Garbled Circuits: Free XOR Delta Recovery](#garbled-circuits-free-xor-delta-recovery)
- [Bigram/Trigram Substitution -> Constraint Solving](#bigramtrigram-substitution---constraint-solving)
- [Shamir Secret Sharing with Deterministic Coefficients](#shamir-secret-sharing-with-deterministic-coefficients)
- [Race Condition in Crypto-Protected Endpoints](#race-condition-in-crypto-protected-endpoints)
- [Garbled Circuits: AES Key Recovery via Metadata Leakage](#garbled-circuits-aes-key-recovery-via-metadata-leakage)
- [Post-Quantum Signature Fault Injection: MAYO](#post-quantum-signature-fault-injection-mayo)
- [Lattice-Based Threshold Signature Attack: FROST](#lattice-based-threshold-signature-attack-frost)
- [Groth16 Broken Trusted Setup — delta == gamma](#groth16-broken-trusted-setup--delta--gamma)
- [Groth16 Proof Replay — Unconstrained Nullifier](#groth16-proof-replay--unconstrained-nullifier)
- [DV-SNARG Forgery via Verifier Oracle](#dv-snarg-forgery-via-verifier-oracle)
- [KZG Pairing Oracle for Permutation Recovery](#kzg-pairing-oracle-for-permutation-recovery)
- [Shamir Secret Sharing with Reused Polynomial Coefficients](#shamir-secret-sharing-with-reused-polynomial-coefficients)
...
**Key insight:** Garbled circuits that use free XOR optimization with fixed keys across sessions leak key material through the AND gate truth tables. Each S-box has a small enough input space (256 values) to brute-force when you know delta. This extends the attack from "recovering delta" to "recovering the entire AES key."
