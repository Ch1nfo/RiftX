...
- [RSA with Restricted-Digit Primes](#rsa-with-restricted-digit-primes)
- [Coppersmith for Structured RSA Primes](#coppersmith-for-structured-rsa-primes)
- [Manger's RSA Padding Oracle Attack](#mangers-rsa-padding-oracle-attack)
- [Manger's Attack on RSA-OAEP via Timing Oracle](mangers-attack-on-rsa-oaep-via-timing-oracle)
- [Polynomial Hash with Trivial Root](#polynomial-hash-with-trivial-root)
- [Polynomial CRT in GF(2)\[x\]]
- [Affine Cipher over Non-Prime Modulus](#affine-cipher-over-non-prime-modulus)
- [Hastad Broadcast Attack with Linear Padding -- Coppersmith](#hastad-broadcast-attack-with-linear-padding----coppersmith)
- [Franklin-Reiter Related Message Attack on RSA e=3](#franklin-reiter-related-message-attack-on-rsa-e3)
- [Coppersmith Attack on Linearly-Related RSA Primes](#coppersmith-attack-on-linearly-related-rsa-primes)
- [rsa-attacks-2.md: RSA p=q Validation Bypass](rsa-attacks-2.md#rsa-pq-validation-bypass)
- rsa-attacks-2.md: RSA Cube Root CRT when gcd(e, phi) > 1
- [rsa-attacks-2.md: Factoring n from Multiple of phi(n)](rsa-attacks-2.md#factoring-n-from-multiple-of-phin)
- [rsa-attacks-2.md: RSA Signature Forgery via Multiplicative Homomorphism](rsa-attacks-2.md#rsa-signature-forgery-via-multiplicative-homomorphism)
- [rsa-attacks-2.md: Weak RSA Key Generation via Base Representation](rsa-attacks-2.md#weak-rsa-key-generation-via-base-representation)
- rsa-attacks-2.md: RSA with gcd(e, phi(n)) > 1
- [rsa-attacks-2.md: Batch GCD for Shared Prime Factoring](rsa-attacks-2.md#batch-gcd-for-shared-prime-factoring)
- [rsa-attacks-2.md: RSA Partial Key Recovery from dp dq qinv](rsa-attacks-2.md#rsa-partial-key-recovery-from-dp-dq-qinv)
- [rsa-attacks-2.md: RSA-CRT Fault Attack / Bit-Flip Recovery](rsa-attacks-2.md#rsa-crt-fault-attack--bit-flip-recovery)
- [rsa-attacks-2.md: RSA Homomorphic Decryption Oracle Bypass](rsa-attacks-2.md#rsa-homomorphic-decryption-oracle-bypass)
- [rsa-attacks-2.md: RSA with Small Prime Factors and CRT Decomposition](rsa-attacks-2.md#rsa-with-small-prime-factors-and-crt-decomposition)
...
**Key insight:** By Fermat's little theorem, if `p-1` divides `B!`, then `a^(B!) ≡ 1 (mod p)`, so `gcd(a^(B!) - 1, n)` gives `p`. Increase `B` for larger smooth bounds. Challenge primes generated with `getStrongPrime()` or similar are resistant.
