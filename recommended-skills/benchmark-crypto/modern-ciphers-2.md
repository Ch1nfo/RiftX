# Benchmark Crypto - Modern Cipher Attacks (Continued)
...
*See also [benchmark-web/auth-infra.md — Hash Length Extension Attack](../benchmark-web/auth-infra.md#hash-length-extension-attack) for the same primitive applied to a web auth token bypass.*
