# Benchmark Crypto - Elliptic Curve Attacks
...
- [Clock Group DLP via Pohlig-Hellman](#clock-group-dlp-via-pohlig-hellman)
- [ECDSA Nonce Reuse](#ecdsa-nonce-reuse)
- [Ed25519 Torsion Side Channel](#ed25519-torsion-side-channel)
- [DSA Nonce Reuse for Private Key Recovery](#dsa-nonce-reuse-for-private-key-recovery)
- [DSA Limited k-Value Brute Force](#dsa-limited-k-value-brute-force)
- [ECC Shared Prime Factor via GCD](#ecc-shared-prime-factor-via-gcd)
- [DSA Key Recovery via MD5 Collision on k-Generation](#dsa-key-recovery-via-md5-collision-on-k-generation)
- [Ed25519 Same-Nonce Key Recovery](#ed25519-same-nonce-key-recovery)
- [Singular Curve ECDLP to Additive/Multiplicative Group](#singular-curve-ecdlp-to-additivemultiplicative-group)
