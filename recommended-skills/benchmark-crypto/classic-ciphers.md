# Benchmark Crypto - Classic Ciphers
...
- [XOR Variants](#xor-variants)
  ...
  - [XOR with Rotation: Power-of-2 Bit Isolation](#xor-with-rotation-power-of-2-bit-isolation)
  - [Weak XOR Verification Brute Force](#weak-xor-verification-brute-force)
- [Deterministic OTP with Load-Balanced Backends](#deterministic-otp-with-load-balanced-backends)
- [OTP Key Reuse / Many-Time Pad XOR](#otp-key-reuse--many-time-pad-xor)
- [Book Cipher](#book-cipher)
- [Variable-Length Homophonic Substitution](#variable-length-homophonic-substitution)
- [Grid Permutation Cipher Keyspace Reduction](#grid-permutation-cipher-keyspace-reduction)
- [Image-Based Caesar Shift Ciphers](#image-based-caesar-shift-ciphers)
...
- [XOR Key Recovery via File Format Headers](#xor-key-recovery-via-file-format-headers)
- [3D Vigenere Palindrome Symmetry Key Recovery](#3d-vigenere-palindrome-symmetry-key-recovery)
- [Nihilist Cipher Double-Crib Key Recovery](#nihilist-cipher-double-crib-key-recovery)
- [16-Byte XOR Block Cipher Structural Reversal](#16-byte-xor-block-cipher-structural-reversal)
- [Flag Semaphore Photo Decoding](#flag-semaphore-photo-decoding)
- [Two-Byte Nibble Reassembly with Random Padding](#two-byte-nibble-reassembly-with-random-padding)
