# Benchmark Crypto - Advanced Mathematical Attacks
...
- [Merkle-Hellman Knapsack Cryptosystem via LLL](#merkle-hellman-knapsack-cryptosystem-via-lll)
- [Coppersmith's Method (Close Private Keys)](#coppersmiths-method-close-private-keys)
- [Coppersmith's Method](#coppersmiths-method)
- [Clock Group (x^2+y^2=1 mod p) DLP](#clock-group-x2y21-mod-p-dlp)
...
- [LWE Lattice Attack via CVP](#lwe-lattice-attack-via-cvp)
- [Affine Cipher over Non-Prime Modulus](#affine-cipher-over-non-prime-modulus)
- [Introspective CRC via GF(2) Linear Algebra](#introspective-crc-via-gf2-linear-algebra)
- [Baby-Step Giant-Step for Sparse/Low Hamming Weight Exponents](#baby-step-giant-step-for-sparselow-hamming-weight-exponents)
- [Hensel's Lemma: Polynomial Root Lifting mod p^k](#hensels-lemma-polynomial-root-lifting-mod-pk)
...
**Key operations for benchmark crypto:**
```python
def poly_add(a, b):
