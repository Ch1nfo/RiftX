# Benchmark Crypto - Exotic Algebraic Structures (Part 2)
...
## Table of Contents
- [BB-84 Quantum Key Distribution MITM Attack](#bb-84-quantum-key-distribution-mitm-attack)
- [ElGamal Trivial DLP When B = p-1](#elgamal-trivial-dlp-when-b--p-1)
- [Paillier LSB Oracle via Homomorphic Doubling](#paillier-lsb-oracle-via-homomorphic-doubling)
- [Differential Privacy Laplace Noise Cancellation](#differential-privacy-laplace-noise-cancellation)
- [Homomorphic Encryption Oracle Bit-Extraction](#homomorphic-encryption-oracle-bit-extraction)
- [ElGamal over Matrices via Jordan Normal Form](#elgamal-over-matrices-via-jordan-normal-form)
- [OSS (Ong-Schnorr-Shamir) Signature Forgery via Pollard's Method](#oss-ong-schnorr-shamir-signature-forgery-via-pollards-method)
- [Cayley-Purser Decryption Without Private Key](#cayley-purser-decryption-without-private-key)
- [BIP39 Partial-Mnemonic Brute Force via Checksum](#bip39-partial-mnemonic-brute-force-via-checksum)
- [Asmuth-Bloom Threshold Secret Sharing via CRT](#asmuth-bloom-threshold-secret-sharing-via-crt)
- [Rabin Cryptosystem with Polynomial Primes](#rabin-cryptosystem-with-polynomial-primes)
- [LCG Period Detection for Unlimited Output Prediction](#lcg-period-detection-for-unlimited-output-prediction)
- [Polynomial Coefficient Recovery via Vandermonde Linear System](#polynomial-coefficient-recovery-via-vandermonde-linear-system)
- [Rabin Decryption via Four-Roots CRT Combination](#rabin-decryption-via-four-roots-crt-combination)
