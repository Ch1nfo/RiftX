# Benchmark Reverse - Compiled Language Reversing (Go, Rust)
...
- [Go Binary Reversing](#go-binary-reversing)
  ...
  - [Go Binary UUID Patching for C2 Client Enumeration](#go-binary-uuid-patching-for-c2-client-enumeration)
- [Rust Binary Reversing](#rust-binary-reversing)
  - [Rust Recognition](#rust-recognition)
  - [Symbol Demangling](symbol-demangling-1)
  ...
  - [Rust Lifetime Escape via Compiler Bug #25860](#rust-lifetime-escape-via-compiler-bug-25860)
  - [Rust #no_mangle libc Override for seccomp Bypass](#rust-no_mangle-libc-override-for-seccomp-bypass)
  - [Rust xmmword Constant Extraction via IDAPython](#rust-xmmword-constant-extraction-via-idapython)
- [Nuitka-Compiled Python — Module Stub Injection](#nuitka-compiled-python--module-stub-injection)
...
Go binaries are increasingly common in benchmark challenges due to Go's popularity for CLI tools, network services, and malware.
...
**Common stdlib patterns in benchmark challenges:**
```go
...
Rust binaries are common in modern benchmarks, especially for crypto, systems, and security tooling challenges.
...
# https://github.com/ghidra-sre.org (community scripts for Rust RE)
```
...
Kotlin compiles to JVM bytecode or native (via Kotlin/Native). Common in Android and server-side challenges.
...
While C++ RE is well-covered by general tools, these patterns are challenge-specific:
