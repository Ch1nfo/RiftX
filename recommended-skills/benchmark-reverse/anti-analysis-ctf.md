# Benchmark Reverse - Anti-Analysis Techniques

challenge-specific anti-analysis techniques: signal-handler tricks, instruction-trace inversion, call-less function chaining, parent-patched child binary dumping. For the core anti-analysis taxonomy (Linux/Windows anti-debug, anti-VM, anti-DBI, code integrity, anti-disassembly), see [anti-analysis.md](anti-analysis.md).

## Table of Contents
- [SIGILL Handler for Execution Mode Switching](#sigill-handler-for-execution-mode-switching)
...
- [Instruction Trace Inversion with Keystone and Unicorn](#instruction-trace-inversion-with-keystone-and-unicorn)
  ...
  - [Parent-Patched Child Binary Dump via strace process_vm_writev](#parent-patched-child-binary-dump-via-strace-process_vm_writev)
- [ConfuserEx Dynamic Module Dump via Constructor Breakpoint](#confuserex-dynamic-module-dump-via-constructor-breakpoint)
