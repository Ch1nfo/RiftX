# Benchmark Reverse - Anti-Analysis Techniques & Bypasses

Comprehensive reference for anti-debugging, anti-VM, anti-DBI, and integrity-check techniques encountered in benchmark challenges, with practical bypasses.
...
- [Linux Anti-Debug (Advanced)](#linux-anti-debug-advanced)
  ...
  - [Trap-Flag Self-Check with cmovz Patcher](#trap-flag-self-check-with-cmovz-patcher)
  - [SIGFPE Handler for mprotect Code Mutation](#sigfpe-handler-for-mprotect-code-mutation)
...
For advanced writeup techniques (SIGILL handler, SIGFPE strace side-channel, instruction trace inversion, call-less function chaining, parent-patched child binary dump), see [anti-analysis-ctf.md](anti-analysis-ctf.md).
...
See [anti-analysis-ctf.md](anti-analysis-ctf.md) for advanced writeup techniques: SIGILL handler for mode switching, SIGFPE strace side-channel, instruction trace inversion, call-less function chaining, and parent-patched child binary dump via `process_vm_writev`.
...
Many benchmark challenges stack multiple checks:
```text
