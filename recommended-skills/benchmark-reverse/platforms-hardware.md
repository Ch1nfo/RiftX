# Benchmark Reverse - Hardware and Advanced Architecture Reversing
...
Beyond basic disassembly (see [tools.md](tools.md)):
...
AArch64 (ARM 64-bit) appears in mobile apps, cloud servers (AWS Graviton), Apple Silicon, and benchmark challenges. Key differences from x86-64 affect both reversing and exploitation.
