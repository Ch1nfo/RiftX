# Benchmark Reverse - Competition-Specific Patterns (Part 3)
...
- [TensorFlow DNN Inversion by Inverting Sigmoid Layers](#tensorflow-dnn-inversion-by-inverting-sigmoid-layers)
- [BPF Filter Analysis via JIT Compilation to x64 Assembly](#bpf-filter-analysis-via-jit-compilation-to-x64-assembly)
- [Single-Byte XOR ROM Deobfuscation Sweep](#single-byte-xor-rom-deobfuscation-sweep)
- [WebKit Array.slice OOB CVE-2016-4622](#webkit-arrayslice-oob-cve-2016-4622)
- [Multi-Modulus CRT Keygen with Matrix Lookup Password](#multi-modulus-crt-keygen-with-matrix-lookup-password)
