# Benchmark Reverse - Dynamic Analysis Tools
...
- [x64dbg (Windows Debugger)](#x64dbg-windows-debugger)
  ...
  - [Scripting](#scripting)
  - [Common Benchmark Workflow](#common-benchmark-workflow)
- [GDB Register Side-Channel on putchar()](#gdb-register-side-channel-on-putchar)
- [radare2 Visual Panels for Custom VM Tracing](#radare2-visual-panels-for-custom-vm-tracing)
- [libSegFault.so Register Dump at Crash](#libsegfaultso-register-dump-at-crash)
- [r2pipe Binary Walking + DP Constraint Solver](#r2pipe-binary-walking--dp-constraint-solver)
- [GDB Commands at strcmp to Recover Dynamic XOR Key](#gdb-commands-at-strcmp-to-recover-dynamic-xor-key)
...
**Key insight:** x64dbg has built-in pattern scanning, hardware breakpoints, and conditional logging. For Windows challenge binaries, it's often faster than IDA/Ghidra for dynamic analysis. Use the **xAnalyzer** plugin for automatic function argument annotation.
