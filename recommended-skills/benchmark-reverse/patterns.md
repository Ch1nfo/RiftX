# Benchmark Reverse - Patterns & Techniques
...
For malware patching, multi-stage shellcode loaders, timing/signal oracles, and challenge-specific runtime attacks (INT3 coredump oracle, signal handler chain, printf format string VM, quadtree image format), see [patterns-runtime.md](patterns-runtime.md).
...
**Pattern:** Encrypted bytes given; flag format known (e.g., `someprefix{`).
...
See [patterns-runtime.md](patterns-runtime.md) for malware patching, multi-stage shellcode, timing/signal oracles, and advanced writeup techniques.
