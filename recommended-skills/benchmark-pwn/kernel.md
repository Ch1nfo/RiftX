# Benchmark Pwn - Linux Kernel Exploitation
...
For tty_struct kROP (kernel Return-Oriented Programming), userfaultfd race stabilization, SLUB internals, cross-cache attacks, and modern kernel exploit patterns, see [kernel-techniques.md](kernel-techniques.md).
