...
- [Protocol Length Field Stack Bleeding](#protocol-length-field-stack-bleeding)
- [Parser Stack Overflow via Unchecked memcpy Length](#parser-stack-overflow-via-unchecked-memcpy-length)
- [Stack Canary Null-Byte Overwrite Leak](#stack-canary-null-byte-overwrite-leak)
- [Empty-Token strncmp(n=0) MAC Bypass](#empty-token-strncmpn0-mac-bypass)
- [Return Address LSB Overwrite + read() Chaining](#return-address-lsb-overwrite--read-chaining)
- [Canary Trailing-Byte Leak via Padding One Byte Past Null](#canary-trailing-byte-leak-via-padding-one-byte-past-null)
- [Index-Only Bounds Check + Stride OOB Write](#index-only-bounds-check--stride-oob-write)
- [Signed Index Negative OOB to Preceding GOT](#signed-index-negative-oob-to-preceding-got)
- [PIE Same-Page Function Pivot via Single-Byte Overwrite](#pie-same-page-function-pivot-via-single-byte-overwrite)
- [scanf Format-Error Skip for Canary Preservation](#scanf-format-error-skip-for-canary-preservation)
