# Benchmark Pwn - Sandbox Escape and Restricted Environments
...
- [process_vm_readv Failure as Sandbox Escape](#process_vm_readv-failure-as-sandbox-escape)
- [Named Pipe mkfifo for File Size Check Bypass](#named-pipe-mkfifo-for-file-size-check-bypass)
- [Lua Integer Underflow via Game Logic](#lua-integer-underflow-via-game-logic)
- [CPU Emulator Print Opcode Python eval Injection](#cpu-emulator-print-opcode-python-eval-injection)
- [Unicorn Emulator Syscall Blacklist Bypass via sysenter and Uncommon Syscalls](#unicorn-emulator-syscall-blacklist-bypass-via-sysenter-and-uncommon-syscalls)
- [Custom VM swap Pointer Self-Overwrite](#custom-vm-swap-pointer-self-overwrite)

---

## Python Sandbox Escape

Python jail/sandbox escape techniques (AST bypass, audit hook bypass, MRO-based builtin recovery, decorator chains, restricted charset tricks, and more) are covered comprehensively in the `benchmark-misc` skill for pyjail techniques.
