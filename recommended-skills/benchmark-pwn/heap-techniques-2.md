...
Continuation of [heap-techniques.md](heap-techniques.md). Part 2 collects challenge-specific UAF, tcache, and custom-allocator variants drawn from individual writeups.
