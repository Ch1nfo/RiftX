# Benchmark Pwn - Format String Exploitation
...
- [Format String for Game State Manipulation](#format-string-for-game-state-manipulation)
- [Format String Saved EBP Overwrite for .bss Pivot](#format-string-saved-ebp-overwrite-for-bss-pivot)
...
- [__printf_chk Bypass with Sequential %p](#__printf_chk-bypass-with-sequential-p)
- [Leak + GOT Overwrite in Single printf Call](#leak--got-overwrite-in-single-printf-call)
- [Objective-C %@ Format Specifier Exploitation (SHA2017)](#objective-c--format-specifier-exploitation-sha2017)
- [strlen Integer Truncation Bypass](#strlen-integer-truncation-bypass)
- [printf_function_table Overwrite via Buffer Overflow](#printf_function_table-overwrite-via-buffer-overflow)
- [scanf Format String on Stack Overwrite](#scanf-format-string-on-stack-overwrite)
- [Format String Exploit Through ROT13 Encoding](#format-string-exploit-through-rot13-encoding)
- [Format String in HTTP User-Agent for PIE Leak](#format-string-in-http-user-agent-for-pie-leak)
- [Null-Byte Address Fragmentation in Small Buffers](#null-byte-address-fragmentation-in-small-buffers)
