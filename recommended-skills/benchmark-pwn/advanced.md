# Benchmark Pwn - Advanced Techniques
...
- [9-Byte test+je Timing Leak](#9-byte-testje-timing-leak)
- [RtlCaptureContext Deterministic Windows Stack Leak](#rtlcapturecontext-deterministic-windows-stack-leak)
- [IEEE 754 Double-as-Shellcode via Exponent Fixing](#ieee-754-double-as-shellcode-via-exponent-fixing)
- [PIE Bypass via Consistent glibc Load Base 0x56555000](#pie-bypass-via-consistent-glibc-load-base-0x56555000)
