# Benchmark Misc - Games, VMs & Constraint Solving (Part 3)

## Table of Contents
- [memfd_create Packed Binaries](#memfd_create-packed-binaries)
- [Multi-Phase Interactive Crypto Game](#multi-phase-interactive-crypto-game)
- [Emulator ROM-Switching State Preservation](#emulator-rom-switching-state-preservation)
- [Python Marshal Code Injection](#python-marshal-code-injection)
- [Benford's Law Frequency Distribution Bypass](#benfords-law-frequency-distribution-bypass)
- [Parallel Connection Oracle Relay](#parallel-connection-oracle-relay)
- [Nonogram Solver to QR Code Pipeline](#nonogram-solver-to-qr-code-pipeline)
- [100 Prisoners Problem / Cycle-Following Strategy](#100-prisoners-problem--cycle-following-strategy)
- [C Code Jail Escape via Emoji Identifiers and Gadget Embedding](#c-code-jail-escape-via-emoji-identifiers-and-gadget-embedding)
...
- [BuildKit Daemon Exploitation for Build Secrets](#buildkit-daemon-exploitation-for-build-secrets)
...
- [15-Puzzle Solvability as Bit Encoder](#15-puzzle-solvability-as-bit-encoder)
- [Levenshtein Distance Oracle Attack](#levenshtein-distance-oracle-attack)
- [SECCOMP Bypass via High-Bit File Descriptor Trick](#seccomp-bypass-via-high-bit-file-descriptor-trick)
- [rvim Jail Escape via Custom vimrc with Python3 Execution](#rvim-jail-escape-via-custom-vimrc-with-python3-execution)
- [Restricted vim Escape via CTRL-W F and netrw File Browser](#restricted-vim-escape-via-ctrl-w-f-and-netrw-file-browser)
- [Taint Analysis Bypass in Custom Language via Type Coercion](#taint-analysis-bypass-in-custom-language-via-type-coercion)
- [Shredded Document Pixel-Edge Reassembly Under Time Pressure](#shredded-document-pixel-edge-reassembly-under-time-pressure)
...
The classic 100 prisoners problem appears in benchmark challenges as an "impossible" probability game:
