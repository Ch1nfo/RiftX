...
- [Sudo Wildcard Parameter Injection via fnmatch](sudo-wildcard-parameter-injection-via-fnmatch)
- [Crafted Pcap for /etc/sudoers.d](crafted-pcap-for-etcsudoersd)
- [Monit confcheck Process Command-Line Injection](monit-confcheck-process-command-line-injection)
- [Apache -d Last-Wins ServerRoot Override](apache--d-last-wins-serverroot-override)
- [Backup Cronjob SUID Abuse](backup-cronjob-suid-abuse)
- [PostgreSQL COPY TO PROGRAM RCE](postgresql-copy-to-program-rce)
- [PostgreSQL Backup Credential Extraction](postgresql-backup-credential-extraction)
- [SSH Unix Socket Tunneling](ssh-unix-socket-tunneling)
- [NFS Share Exploitation for Sensitive Data](nfs-share-exploitation-for-sensitive-data)
- [PaperCut Print Deploy Privilege Escalation](papercut-print-deploy-privilege-escalation)
- [Squid Proxy Pivoting to Internal Services](squid-proxy-pivoting-to-internal-services)
- [Zabbix Admin Password Reset via MySQL](zabbix-admin-password-reset-via-mysql)
- [WinSSHTerm Encrypted Credential Decryption](winsshterm-encrypted-credential-decryption)
- [sudo file -m Magic File Directory Traversal](#sudo-file--m-magic-file-directory-traversal)
- [CVE-2018-19788 — polkit UID Integer Overflow → Systemd RCE](#cve-2018-19788--polkit-uid-integer-overflow--systemd-rce)
- [Sudo Glob Path + Symlink Confused Deputy via vim](#sudo-glob-path--symlink-confused-deputy-via-vim)
- [TOCTOU Symlink Swap Race on FileChecker](#toctou-symlink-swap-race-on-filechecker)
