# Benchmark Misc - Games, VMs & Constraint Solving (Part 2)

## Table of Contents
- [Cookie Checkpoint Game Brute-Forcing](#cookie-checkpoint-game-brute-forcing)
- [Flask Session Cookie Game State Leakage](#flask-session-cookie-game-state-leakage)
- [WebSocket Game Manipulation + Cryptic Hint Decoding](#websocket-game-manipulation--cryptic-hint-decoding)
- [Server Time-Only Validation Bypass](#server-time-only-validation-bypass)
- [De Bruijn Sequence for Substring Coverage](#de-bruijn-sequence-for-substring-coverage)
- [Brainfuck Interpreter Instrumentation](#brainfuck-interpreter-instrumentation)
- [WASM Linear Memory Manipulation](#wasm-linear-memory-manipulation)
