...
- [func_globals to Module Chain Traversal](#func_globals-to-module-chain-traversal)
- [Restricted Charset Number Generation](#restricted-charset-number-generation)
- [Multi-Stage Payload with Class Attribute Persistence](#multi-stage-payload-with-class-attribute-persistence)
- [dir() Attribute Lookup Escape Bypassing __class__ Blocklist](#dir-attribute-lookup-escape-bypassing-__class__-blocklist)
- [Restricted vim Escape via K (man) to :!sh](#restricted-vim-escape-via-k-man-to-sh)
- [Python Name Mangling and Attribute Access](#python-name-mangling-and-attribute-access)
...
- [Quine + Context Detection for Code Execution](#quine--context-detection-for-code-execution)
- [Restricted Character Repunit Decomposition](#restricted-character-repunit-decomposition)
- [Python eval() Jail Escape via Tuple Injection](#python-eval-jail-escape-via-tuple-injection)
- [Python f-string Config Injection via Stored eval](#python-f-string-config-injection-via-stored-eval)
