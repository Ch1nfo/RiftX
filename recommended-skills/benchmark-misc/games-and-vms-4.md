# Benchmark Misc - Games, VMs & Constraint Solving (Part 4)

Additional advanced challenge patterns. For earlier parts, see [games-and-vms.md](games-and-vms.md), [games-and-vms-2.md](games-and-vms-2.md), and [games-and-vms-3.md](games-and-vms-3.md).

## Table of Contents
- [XSLT as Turing-Complete VM for Binary Search](#xslt-as-turing-complete-vm-for-binary-search)
- [JavaScript MAX_SAFE_INTEGER Successor Equality](#javascript-max_safe_integer-successor-equality)
- [Binary Search Oracle in Comparison-Only DSL](#binary-search-oracle-in-comparison-only-dsl)
- [Blind SQLi via Script-Engine Timeout Error](#blind-sqli-via-script-engine-timeout-error)
- [OEIS Sequence Lookup Automation for Recurrence Puzzles](#oeis-sequence-lookup-automation-for-recurrence-puzzles)
- [QR Code Reassembly from Format-String Structural Constraints](#qr-code-reassembly-from-format-string-structural-constraints)
- [Matrix Exponentiation for Fibonacci-Like Recurrence](#matrix-exponentiation-for-fibonacci-like-recurrence)
- [Tribonacci Recurrence for Frog Jump Counting](#tribonacci-recurrence-for-frog-jump-counting)
- [Selenium + Tesseract for Dynamic Font CAPTCHA](#selenium--tesseract-for-dynamic-font-captcha)
- [Brainfuck Decodes Piet Image URL — Multi-Layer Polyglot](#brainfuck-decodes-piet-image-url--multi-layer-polyglot)
- [Bytebeat Synth Code Recognition for Hidden Audio](#bytebeat-synth-code-recognition-for-hidden-audio)
