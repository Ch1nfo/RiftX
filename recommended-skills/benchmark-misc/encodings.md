# Benchmark Misc - Encodings & Media
...
- [Common Encodings](#common-encodings)
  ...
  - [UTF-16 Endianness Reversal](#utf-16-endianness-reversal)
  - [BCD (Binary-Coded Decimal) Encoding](#bcd-binary-coded-decimal-encoding)
  - [Multi-Layer Encoding Detection](#multi-layer-encoding-detection)
...
- [QR Codes](#qr-codes)
  ...
  - [QR Code Chunk Reassembly](#qr-code-chunk-reassembly)
  - [QR Code Chunk Reassembly via Indexed Directories](#qr-code-chunk-reassembly-via-indexed-directories)
- [Multi-Stage URL Encoding Chain](#multi-stage-url-encoding-chain)
- [Esoteric Languages](#esoteric-languages)
  - [Whitespace Language Parser](#whitespace-language-parser)
  - [Custom Brainfuck Variants (Themed Esolangs)](#custom-brainfuck-variants-themed-esolangs)
  - [Multi-Layer Esoteric Language Chains](#multi-layer-esoteric-language-chains)
- [base65536 CJK Unicode Binary Encoding](#base65536-cjk-unicode-binary-encoding)
...
**Key insight:** Unlike the shuffled-chunk variant (requiring structural analysis), indexed chunks just need sorting. The challenge is recognizing that directory names are base64-encoded indices. Check `base64 -d` on folder names when they look like random strings.
...
**Pattern:** File contains repetitive themed words (e.g., "arch", "linux", "btw") used as substitutes for Brainfuck operations. Common in easy/misc benchmark challenges.
