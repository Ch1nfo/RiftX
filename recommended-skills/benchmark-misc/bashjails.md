# Benchmark Misc - Bash Jails & Restricted Shells
...
- [HISTFILE Trick for Restricted Shell File Reads](#histfile-trick-for-restricted-shell-file-reads)
- [Bash Jail Bypass via $'...' Octal Encoding](#bash-jail-bypass-via--octal-encoding)
- [LD_PRELOAD Hook via rbash-Allowed Variable Set](#ld_preload-hook-via-rbash-allowed-variable-set)
- [/dev/tcp Exfiltration from Minimal Command Set](#devtcp-exfiltration-from-minimal-command-set)
- [Layer-by-Layer Echo-Only Bash Escape](#layer-by-layer-echo-only-bash-escape)
- [Closed-Stdout Jail with \r Truncation](#closed-stdout-jail-with-r-truncation)
