# Benchmark Web - Server-Side Injection Attacks
...
- [SSTI (Server-Side Template Injection)](#ssti-server-side-template-injection)
  ...
  - [ERB SSTI + Sequel::DATABASES Bypass](#erb-ssti--sequeldatabases-bypass)
  - [Mako SSTI](#mako-ssti)
  - [Twig SSTI](#twig-ssti)
  - [Vue.js Template Injection via toString.constructor](#vuejs-template-injection-via-tostringconstructor)
  - [SSTI Quote Filter Bypass via `__dict__.update()`](#ssti-quote-filter-bypass-via-__dict__update)
- [SSRF](#ssrf)
  - [Host Header SSRF](#host-header-ssrf)
  ...
  - [Unescaped-Dot Regex Allowlist Bypass](#unescaped-dot-regex-allowlist-bypass)
  - [SNI-Based FTP Protocol Smuggling via HTTPS](#sni-based-ftp-protocol-smuggling-via-https)
  - [Apache mod_vhost_alias Docroot Override via Host Header](#apache-mod_vhost_alias-docroot-override-via-host-header)
- [PHP hash_hmac Returns NULL with Array Input](#php-hash_hmac-returns-null-with-array-input)
- [Smarty SSTI via CVE-2017-1000480 Comment Injection](#smarty-ssti-via-cve-2017-1000480-comment-injection)
- [Recursive-Replace Traversal `....//`](#recursive-replace-traversal-)
- [PHP (int) Cast Leading-Number Traversal](#php-int-cast-leading-number-traversal)
- [strpos Substring-Match Blacklist Bypass](#strpos-substring-match-blacklist-bypass)
- [User-Agent-Gated robots.txt](#user-agent-gated-robotstxt)
- [PHP log()/INF Math Equality + Recursive urldecode()](#php-loginf-math-equality--recursive-urldecode)
