# Benchmark Web - OAuth, SAML & Infrastructure Auth Attacks
...
- [Git History Credential Leakage](git-history-credential-leakage)
- [CI/CD Variable Credential Theft](cicd-variable-credential-theft)
- [Identity Provider API Takeover](identity-provider-api-takeover)
- [SAML SSO Flow Automation](saml-sso-flow-automation)
- [Apache Guacamole Connection Parameter Extraction](apache-guacamole-connection-parameter-extraction)
- [Login Page Poisoning for Credential Harvesting](login-page-poisoning-for-credential-harvesting)
- [TeamCity REST API RCE](teamcity-rest-api-rce)
...
*See also [benchmark-crypto/modern-ciphers-2.md — Hash Length Extension Attack](../benchmark-crypto/modern-crypto/../modern-ciphers-2.md#hash-length-extension-attack) for the canonical crypto writeup of the same primitive.*
