# Benchmark Web - Client-Side Attacks
...
- [Cache Poisoning](#cache-poisoning)
  - [X-Forwarded-Host CDN Template Fetch Poisoning](#x-forwarded-host-cdn-template-fetch-poisoning)
...
- [JPEG+HTML Polyglot XSS](#jpeghtml-polyglot-xss)
- [JSFuck Decoding](#jsfuck-decoding)
- [AngularJS 1.x Sandbox Escape via charAt/trim Override](#angularjs-1x-sandbox-escape-via-charattrim-override)
...
**PoW bypass:** Many benchmark report endpoints require SHA-256 proof-of-work:
```python
import hashlib
nonce = 0
while True:
