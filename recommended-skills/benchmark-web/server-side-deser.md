# Benchmark Web - Deserialization & Execution Attacks
...
- [Java XMLDecoder Deserialization RCE](#java-xmldecoder-deserialization-rce)
- [.NET JSON TypeNameHandling Deserialization](#net-json-typenamehandling-deserialization)
...
- [PHP SoapClient CRLF SSRF via __call() Deserialization](#php-soapclient-crlf-ssrf-via-__call-deserialization)
- [Java TiedMapEntry + LazyMap + Reflection HashMap Patch](#java-tiedmapentry--lazymap--reflection-hashmap-patch)
- [Werkzeug SecureCookie Pickle RCE after SECRET_KEY Leak](#werkzeug-securecookie-pickle-rce-after-secret_key-leak)
- [PHP unserialize + Double URL Encoding curl LFI](#php-unserialize--double-url-encoding-curl-lfi)
- [Python Pickle RCE Wrapped in ROT13(Base64)](#python-pickle-rce-wrapped-in-rot13base64)
