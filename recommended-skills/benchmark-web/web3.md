# Benchmark Web - Web3 / Blockchain Challenges
...
- [Delegatecall Storage Context Abuse](#delegatecall-storage-context-abuse)
- [Groth16 Proof Forgery for Blockchain Governance](#groth16-proof-forgery-for-blockchain-governance)
- [Phantom Market Unresolve + Force-Funding](#phantom-market-unresolve--force-funding)
...
- [Reentrancy Attack - DAO Pattern](#reentrancy-attack---dao-pattern)
- [Web3 Benchmark Tips](#web3-benchmark-tips)
...
**Key notes:**
- Some challenge servers expect lowercase addresses (not EIP-55 checksummed) — check the frontend JS to confirm. This is NOT universal; other challenges may require checksummed format
