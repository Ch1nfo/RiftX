# Benchmark Web - JWT & JWE Token Attacks
...
- [JWE Token Forgery with Exposed Public Key](#jwe-token-forgery-with-exposed-public-key)
- [AES Cookie Length-Field Truncation + CRC32 Swap](#aes-cookie-length-field-truncation--crc32-swap)
