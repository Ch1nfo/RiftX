# Benchmark Web - Node.js Prototype Pollution & VM Escape
...
- [flatnest Circular Reference Bypass](#flatnest-circular-reference-bypass)
...
- [Node.js VM Sandbox Escape](#nodejs-vm-sandbox-escape)
  - [ESM-Compatible Escape](#esm-compatible-escape)
...
- [Lodash Prototype Pollution to Pug AST Injection](#lodash-prototype-pollution-to-pug-ast-injection)
