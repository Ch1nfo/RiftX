# Benchmark Web - XXE, XML Injection, Command Injection, GraphQL
...
- [XXE (XML External Entity)](#xxe-xml-external-entity)
  ...
  - [XXE via DOCX/Office XML Upload](#xxe-via-docxoffice-xml-upload)
  - [SVG XXE via svglib to PNG Pipeline](#svg-xxe-via-svglib-to-png-pipeline)
- [XML Injection via X-Forwarded-For Header](#xml-injection-via-x-forwarded-for-header)
- [PHP Variable Variables ($$var) Abuse](#php-variable-variables-var-abuse)
- [PHP uniqid() Predictable Filename](#php-uniqid-predictable-filename)
- [Sequential Regex Replacement Bypass](#sequential-regex-replacement-bypass)
- [Command Injection](#command-injection)
  - [Newline Bypass](#newline-bypass)
  - [Incomplete Blocklist Bypass](#incomplete-blocklist-bypass)
  - [Sendmail Parameter Injection via CGI](#sendmail-parameter-injection-via-cgi)
  - [Multi-Barcode Concatenation to Shell Injection](#multi-barcode-concatenation-to-shell-injection)
  - [Git CLI Newline Injection via URL Path](#git-cli-newline-injection-via-url-path)
- [GraphQL Injection and Exploitation](#graphql-injection-and-exploitation)
