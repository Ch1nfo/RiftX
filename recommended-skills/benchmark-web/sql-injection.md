# Benchmark Web - SQL Injection Techniques

Comprehensive SQL injection techniques for benchmark challenges. For other server-side attacks (SSTI, SSRF, XXE, command injection, GraphQL), see [server-side.md](server-side.md).
