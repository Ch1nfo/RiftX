# Benchmark Web - Server-Side Code Execution & Access Attacks
...
- [Ruby ObjectSpace Memory Scanning for Flag Extraction](#ruby-objectspace-memory-scanning-for-flag-extraction)
- [Perl open() RCE](#perl-open-rce)
- [LaTeX Injection RCE](#latex-injection-rce)
- [Server-Side JS eval Blocklist Bypass](#server-side-js-eval-blocklist-bypass)
- [PHP preg_replace /e Modifier RCE](#php-preg_replace-e-modifier-rce)
- [PHP Backtick Eval Under Character Limit](#php-backtick-eval-under-character-limit)
- [PHP assert() String Evaluation Injection](#php-assert-string-evaluation-injection)
- [Prolog Injection](#prolog-injection)
...
- [File Upload to RCE Techniques](#file-upload-to-rce-techniques)
  ...
  - [Gogs Symlink RCE](#gogs-symlink-rce)
  - [ZipSlip + SQLi](#zipslip--sqli)
- [PHP Deserialization from Cookies](#php-deserialization-from-cookies)
- [PHP extract() / register_globals Variable Overwrite](#php-extract--register_globals-variable-overwrite)
...
- [Thymeleaf SpEL SSTI + Spring FileCopyUtils WAF Bypass](#thymeleaf-spel-ssti--spring-filecopyutils-waf-bypass)
- [PHP eval() Function-Regex Bypass via current(getallheaders())](#php-eval-function-regex-bypass-via-currentgetallheaders)
- [Python f-string Format Injection Blind Extraction](#python-f-string-format-injection-blind-extraction)
