export type RiftxErrorCode = "SESSION_ARCHIVED" | "SESSION_NOT_IN_WORKSPACE" | "SESSION_NOT_FOUND" | "SESSION_NOT_ARCHIVED" | "SESSION_BUSY" | "MODEL_AUTH_MISSING" | "INVALID_WORKING_DIRECTORY" | "MODEL_DOES_NOT_SUPPORT_IMAGES" | "DUPLICATE_REQUEST_ID" | "BENCHMARK_CONFIG_REQUIRED" | "BENCHMARK_CONTAINER_CLOSE_FAILED";
