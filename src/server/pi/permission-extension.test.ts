...
// Lock coordination (BashConcurrency / MutationLock) moved out of this
// extension into the tool execute wrappers createRuntimeSession installs in
// session-manager; the extension-level lock tests went with it.
